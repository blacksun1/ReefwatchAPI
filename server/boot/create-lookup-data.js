  ...
  function createBeaufortScale(cb) {
    mongoDs.automigrate('BeaufortScale', function(err) {
      ...
      BeaufortScale.create([{
        scale: 1,
        scaleDescription: 'Wind: Light air | Sea State: Calm |' +
          'Mirror-like to small ripples',
      },
      {
        scale: 2,
        scaleDescription: 'Wind: Gentle breeze | Sea State: Smooth | ' +
          'Large wavelets, crests begn to break',
      },
      {
        scale: 3,
        scaleDescription: 'Wind: Moderate breeze | Sea State: Slight | ' +
          'Small waves becoming longer',
      },
      {
        scale: 4,
        scaleDescription: 'Wind: Fresh breeze | Sea State: Moderate | ' +
          'Many white caps forming',
      },
      {
        scale: 5,
        scaleDescription: 'Wind: Strong breeze | Sea State: Rough | ' +
          'Large waves, extensive white caps',
      },
      ], cb);
    });
  }
